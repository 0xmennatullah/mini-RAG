...
- for some reason, postman keeps crashing on fedora; so passing for now => update: using resonance instead, better linux compatibility.
- 

### routes
- default route: @app.get("/") => health ckeck, tests.
